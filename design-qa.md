...
- **Resolved P1 — Corner buildings overlapped the south road.** Both side skylines now stop at `z = 33`, leaving a clear buffer before the road envelope. The south skyline is centered on a symmetric grid and remains fully inside its paved foundation.
